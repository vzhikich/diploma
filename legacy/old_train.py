...
X = data_dict['data']      # shape: (N, SEQ_LEN, 84)
y = data_dict['labels']    # shape: (N,)

print("X shape:", X.shape)
print("y shape:", y.shape)

SEQ_LEN = X.shape[1]       # e.g. 30
FEATURES = X.shape[2]      # 84 (dx, dy, r, angle for 21 landmarks)

# === TRAIN / TEST SPLIT ===
# If you currently have only one class (e.g. only 'HELLO'),
# sklearn's stratify can be omitted.
